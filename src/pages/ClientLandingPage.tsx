...
const ClientLandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-white text-gray-800">
      <SEO
        title="TGT Contratto | Guia de Negócios e Serviços em Cascavel"
        description="Explore as melhores empresas e serviços em Cascavel e região. TGT Contratto conecta você com profissionais de contabilidade, engenharia, estética e muito mais."
        keywords="empresas em cascavel, serviços cascavel, contabilidade cascavel, engenharia cascavel, cabelereiros cascavel"
      />
      {/* Hero Section */}
      <HeroSection />
