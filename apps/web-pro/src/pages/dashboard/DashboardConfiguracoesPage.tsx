          ...
          {activeTab === 'assinatura' && (
            <div className="space-y-6 max-w-2xl">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">Gerencie seu plano, faturas e métodos de pagamento</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl border border-gray-100 bg-gray-50/50">
                  <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Cobrança</p>
                  <p className="text-xs text-gray-700 font-medium">Os pagamentos são processados via Stripe de forma segura.</p>
                </div>
                <div className="p-4 rounded-xl border border-gray-100 bg-gray-50/50">
                  <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Dúvidas?</p>
