        ...
        <SafeAreaView style={styles.container} edges={['top']} aria-label="Dashboard">
            <View style={styles.header}>
                ...
                <View style={styles.headerActions}>
                    <TouchableOpacity style={styles.iconBtn} onPress={() => navigateTo('/scan-qr')}>
            ...
            >
                ...
                <View style={styles.quickGrid}>
                    {[
                        { icon: 'construct-outline', label: 'Serviços', route: '/(tabs)/services', color: '#0EA5E9' },
                        { icon: 'calendar-outline', label: 'Agenda', route: '/(tabs)/calendar', color: Colors.info },
                        { icon: 'chatbubbles-outline', label: 'Mensagens', route: '/(tabs)/messages', color: Colors.warning },
