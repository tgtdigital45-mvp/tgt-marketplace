                    ...
                    <FadeInView delay={200} translateY={10}>
                        <View style={styles.section}>
                            ...
                            <View style={styles.card}>
                                ...
                                {renderMenuItem('calendar-outline', 'Agenda', 'Calendário de compromissos', () => navigateTo('/(tabs)/calendar'), Colors.info)}
                                <View style={styles.divider} />
                                {renderMenuItem('list-outline', 'Serviços', 'Gerencie seu catálogo', () => navigateTo('/(tabs)/services'), '#0EA5E9')}
                                <View style={styles.divider} />
