        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12 mb-12 pb-10 border-b border-slate-800">
          <div className="max-w-sm">
            <Link to="/" className="inline-block mb-4">
              <img src="/logo-contratto.png" alt="CONTRATTO" className="h-12 sm:h-14 w-auto brightness-0 invert opacity-90 object-contain" />
            </Link>
          ...
          <div className="w-full lg:max-w-md">
            <WaitlistForm className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700" />
          </div>
        </div>
