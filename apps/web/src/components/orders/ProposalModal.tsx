...
import { XMarkIcon, DocumentTextIcon, BanknotesIcon } from '@heroicons/react/24/outline';
...
export const ProposalModal: React.FC<ProposalModalProps> = ({ 
    ...
    const handleSubmit = async () => {
        if (!description || !totalValue || isSubmitting) return;
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-lg text-gray-900">Enviar Proposta</h3>
                    </div>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-brand-primary outline-none transition-shadow min-h-[100px]"
                            required
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            >
                                <option value={30}>30% Entrada / 70% Final</option>
                                <option value={50}>50% Entrada / 50% Final</option>
                    ...
                    {fees && (
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 space-y-3">
                            ...
                            <div className="pt-2 border-t border-gray-200 mt-2 flex justify-between items-center">
                                <span className="font-bold text-gray-900">Você Recebe Líquido:</span>
                                <span className="font-bold text-green-600 text-lg">{formatCurrency(fees.sellerNet)}</span>
                            </div>

                            <div className="mt-2 text-xs text-gray-400 text-center bg-gray-100 p-2 rounded">
                                O cliente pagará {formatCurrency(fees.upfrontAmount)} ({upfrontPercentage}%) para iniciar.
                            </div>
                        </div>
                    )}
                </div>
                ...
                <div className="flex items-center justify-end gap-3 px-6 py-4 bg-gray-50 border-t border-gray-100">
                    ...
                    <Button 
                        ...
                        disabled={!totalValue || !description}
                    >
                        Enviar Proposta
                    </Button>
                </div>
