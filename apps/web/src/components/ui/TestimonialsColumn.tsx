                    ...
                    ...new Array(2).fill(0).map((_, index) => (
                        <React.Fragment key={index}>
                            {testimonials.map(({ text, image, name, role }, i) => (
                                <div
                                    className="p-10 rounded-3xl border shadow-lg shadow-primary-600/10 max-w-xs w-full bg-white"
                                    key={i}
                                >
                                    ...
                                    <div className="flex items-center gap-2 mt-5">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <div className="leading-5 opacity-60 tracking-tight text-slate-600 text-sm">
                                                {role}
                                            </div>
                                        </div>
                                    </div>
