-- Drop old functions since return signature changed
...
-- Recreate get_nearby_services with company_cover_url
...
-- Recreate get_remote_services with company_cover_url
